...
# Author: Martin Jauquet and Darwin Castillo
# This class is used to open the csv of the dataset and open the image and aquire the associated labels with each image. 
import os
import torch
...
class OysterDetectionDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img_id = torch.as_tensor([index])   # name of image
